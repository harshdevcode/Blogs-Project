...
export default function CookiePreferences({ closeCookieDialog }) {
  function handlingSwitchingTab(choice){
          ...
          <div className="flex flex-col relative rounded-lg bg-white shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl" style={{minHeight: "70vh"}}>
            ...
            <div className="modal-body sm:flex grow bg-white border-b-2">
              <div className="modal-sidebar sm:border-r-2 sm:w-1/4 min-w-max flex flex-col">
                <button className="text-left p-5 hover:bg-gray-200 focus:bg-gray-300" onClick={() => setSelectedTab("consent")}>Cookie Consent</button>
                <button className="text-left p-5 hover:bg-gray-200 focus:bg-gray-300" onClick={() => setSelectedTab('mandatory')}>Strictly Necessary Cookies</button>
                <button className="text-left p-5 hover:bg-gray-200 focus:bg-gray-300" onClick={() => setSelectedTab('performance')}>Performance Cookies</button>
              </div>
            ...
            <div className="modal-btncontainer bg-gray-50 px-4 py-3 sm:flex sm:px-6">
              <button type="button" onClick={closeCookieDialog} className="w-full rounded-md bg-red-600 m-auto px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:w-auto"
              >I understand
              </button>
            </div>
          </div>
